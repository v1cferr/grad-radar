...
- Name: dashboard.spec.ts >> warns that the site label contradicts the real status
- Location: e2e/dashboard.spec.ts:88:5
...
Locator: getByText(/O site ainda rotula este processo como/)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/O site ainda rotula este processo como/)
